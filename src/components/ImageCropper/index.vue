...
export default {
    ...
    methods: {
        ...
        prepareUpload() {
            ...
            this.base64 = createImgUrl.split('base64,')[1];
        ...
        upload() {
            ...
            if(this.notObj){
                this.showLoading()
                this.$http.post(url,this.base64,{headers: { "Content-Type": "application/json;charset=UTF-8"}}).then(resData => {
                    that.loading = 2
                ...
                this.$http({
                    url,
                    method: 'post',
                    data: this.notObj ? params : fmData
                }).then(resData => {
                    that.loading = 2
                    that.$emit('crop-upload-success', resData.data)
                }).catch(err => {
